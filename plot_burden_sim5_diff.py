...
experiment_list = ['nhh2pert','shh2pert','avih2pert','shiph2pert']


#experiment_id = 'transient2010s'


linestylelist = { 'nhh2pert':':',
                  'shh2pert':'-',
                  'avih2pert':'--',
                  'shiph2pert':'-.'}
    ...
    for v,variable_id in enumerate(variable_list):
        ...
        for experiment_id in experiment_list:
            ...
            if os.path.exists(filename):
                ...
                ax.plot(burden_yearmean.index, burden_yearmean,linestyle =linestylelist[experiment_id],color=color_list[model_id],label=experiment_id + " ({:.3f})".format(burden_yearmean.mean()))
            else:
